...
class TLDetector(object):
    ...
    def get_light_state(self, light):
        ...
        tl_box = self.light_classifier.get_localization(cv_image)
        rospy.logwarn("box: {0}".format(tl_box))
        #print(tl_box)
    ...
    def process_traffic_lights(self):
        ...
        #rospy.logwarn("stop_line_positions: {0}".format(stop_line_positions))
        if(self.pose):
        ...
        #TODO find the closest visible traffic light (if one exists)
            ...
            for i,light in enumerate(self.lights):
                ...
                # find closest stop line waypointt index
